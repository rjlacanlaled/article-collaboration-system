        ...
        <div className="max-w-7xl mx-auto pb-6 px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div className='flex justify-start items-center w-content mt-4'>
                ...
                <h2 className='text-sm text-gray-900 ml-2'>Bryan Saguit</h2>
            </div>
          </div>
              ...
              <div className="px-4 py-5 sm:p-6">
                <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-1">
                    ...
                    <dd className="mt-1 text-sm text-gray-900">Wick</dd>
                  </div>
                  <div className="sm:col-span-1">
                    <dt className="text-sm font-medium text-gray-500">Birthday</dt>
                    <dd className="mt-1 text-sm text-gray-900">07/07/1998</dd>
                  </div>
                  <div className="sm:col-span-1">
                    <dt className="text-sm font-medium text-gray-500">Email address</dt>
                    <dd className="mt-1 text-sm text-gray-900">fakerbryan@yahoo.com</dd>
                  </div>
                  <div className="sm:col-span-1">
                    <dt className="text-sm font-medium text-gray-500">Phone number</dt>
                    <dd className="mt-1 text-sm text-gray-900">09957810229</dd>
                  </div>
                  <div className="sm:col-span-1">
