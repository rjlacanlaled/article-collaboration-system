                ...
                <div className="px-4 py-5 sm:p-6">
                  <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                    <div className="sm:col-span-1">
                      ...
                      <dd className="mt-1 text-sm text-gray-900 tracking-wider">{user.firstname}</dd>
                    </div>
                    <div className="sm:col-span-1">
                      <dt className="text-sm font-medium text-zinc-500">Middle Name</dt>
                      <dd className="mt-1 text-sm text-gray-900 tracking-wider">Farne</dd>
                    </div>
                    <div className="sm:col-span-1">
                      <dt className="text-sm font-medium text-zinc-500">Last Name</dt>
                      <dd className="mt-1 text-sm text-gray-900 tracking-wider">{user.lastname}</dd>
                    </div>
                    <div className="sm:col-span-1">
                      <dt className="text-sm font-medium text-zinc-500">Email address</dt>
                      <dd className="mt-1 text-sm text-gray-900 tracking-wider">{user.email}</dd>
                    </div>
                  </dl>
                </div>
              </div>
