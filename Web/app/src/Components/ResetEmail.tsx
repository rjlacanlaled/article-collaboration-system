  ...
  return (
    <AuthPage>
        <div className="bg-white p-8 w-96  rounded-lg shadow-lg flex justify-center items-center flex-col">
            ...
            <h2 className="mb-6 font-bold text-3xl text-zinc-700">Check Your Email</h2>
            <p className="text-sm text-center w-11/12 text-zinc-500 tracking-wider">Please Check the email address fakerbryan@yahoo.com for instructions to reset your password</p>
            <button 
