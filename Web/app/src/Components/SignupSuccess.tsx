  ...
  return (
    <AuthPage> 
      <div className="bg-white w-2/4 p-8 h-5/6 rounded-lg shadow-lg flex items-center justify-center flex-col">
        ...
        <p className="text-base leading-relaxed text-center w-3/4 text-zinc-500 tracking-wider">Thank you for signing up! Your account registration is complete. Our admin will now review your account, and once it has been approved, you will be able to log in. Please wait patiently.</p>
        <Link to={`/`}>
