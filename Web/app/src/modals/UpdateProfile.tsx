  ...
  return (
    <>
      <div className="bg-white w-fit self-end drop-shadow rounded-lg text-sm hover:bg-gray-100 duration-200">
        <button onClick={() => setOpen(true)} className="tracking-wide py-2 px-2 text-zinc-700 hover:bg-zinc-100 rounded-lg">
          Edit Profile
        </button>
      </div>
      <Modal open={open} onClose={() => setOpen(false)}>
        <ModalDialog aria-labelledby="basic-modal-dialog-title" aria-describedby="basic-modal-dialog-description" sx={{ maxWidth: 500 }} size="lg">
          ...
          <form>
            <Stack spacing={2}>
              ...
              <FormControl>
                ...
                <Input type="text" name="middlename" value={profileData?.middlename} onChange={handleChange} />
              </FormControl>
